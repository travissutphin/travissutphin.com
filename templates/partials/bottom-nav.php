...
<nav class="md:hidden fixed bottom-0 left-0 right-0 bg-dark-green border-t border-dark-green z-50">
    <div class="grid grid-cols-5 items-center">
        <!-- Home -->
        <a href="<?php echo BASE_PATH; ?>/"
           class="flex flex-col items-center justify-center py-2 px-3 <?php echo $current_page === 'home' ? 'text-primary-green' : 'text-white'; ?>">
        ...
        <a href="<?php echo BASE_PATH; ?>/projects"
           class="flex flex-col items-center justify-center py-2 px-3 <?php echo $current_page === 'projects' ? 'text-primary-green' : 'text-white'; ?>">
        ...
        <button id="social-menu-btn"
            ...
            <span class="text-xs text-white mt-1">Connect</span>
        </button>

        <!-- Blog -->
        <a href="<?php echo BASE_PATH; ?>/blog"
           class="flex flex-col items-center justify-center py-2 px-3 <?php echo strpos($current_page, 'blog') === 0 ? 'text-primary-green' : 'text-white'; ?>">
        ...
        <a href="<?php echo BASE_PATH; ?>/contact"
           class="flex flex-col items-center justify-center py-2 px-3 <?php echo $current_page === 'contact' ? 'text-primary-green' : 'text-white'; ?>">
...
<div id="social-popup" class="hidden fixed inset-0 z-40 md:hidden">
    ...
    <!-- Popup Content -->
    <div class="absolute bottom-20 left-1/2 transform -translate-x-1/2 bg-white rounded-2xl shadow-xl p-6 w-11/12 max-w-sm">
        <h3 class="text-center font-semibold text-dark-green mb-4">Connect With Me</h3>

        <div class="grid grid-cols-4 gap-4">
            <a href="https://github.com" target="_blank" rel="noopener noreferrer"
               class="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-light transition-colors">
                ...
                <span class="text-xs text-gray-dark">GitHub</span>
            </a>
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer"
               class="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-light transition-colors">
                ...
                <span class="text-xs text-gray-dark">LinkedIn</span>
            </a>
            ...
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer"
               class="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-light transition-colors">
                ...
                <span class="text-xs text-gray-dark">Twitter</span>
            </a>
            ...
            <a href="mailto:<?php echo SITE_EMAIL; ?>"
               class="flex flex-col items-center justify-center p-3 rounded-lg hover:bg-gray-light transition-colors">
                ...
                <span class="text-xs text-gray-dark">Email</span>
            </a>
        </div>

        <button id="close-social" class="mt-4 w-full py-2 text-gray-dark text-sm">
            Close
        </button>
    </div>
</div>
